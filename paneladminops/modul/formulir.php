<div class="col-lg-6">
    <div class="well scroll">
        <form class="form-horizontal" id="form1" action="modul/aksipendaftar.php" method="post" name='autoSumForm'
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="nopendaftaran" id="nopendaftaran" value="<?php echo $a['nopendaftaran']; ?>"
