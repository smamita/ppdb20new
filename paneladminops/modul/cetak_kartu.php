...
<table cellpadding='5' cellspacing='0' style='font-family:arial;width:550px;font-size:11pt;'>
  <tr>
	...
	<td>:</td>
    <td style='font-weight:bold;font-size:12pt;'>20501861<?php echo $a['nopendaftaran']; ?> (Bank Muamalat)</td>
  </tr>
  <tr>
    <td>Nama</td>
	<td>:</td>
  ...
  <tr>
	...
	<td>:</td>
    <td style='font-weight:bold;background:#000;color:#fff;text-align:right;font-size:14pt;'>Rp.<?php $harga_formulir=number_format($a['harga_formulir']);echo $harga_formulir; ?>,-</td>
  </tr>
</table>
<br>
...
<i>Rekening di atas adalah Rekening Virtual Bank Muamalat. <br>
  Info lengkap
  <a target="_blank" href="http://ppdb18.smam1ta.sch.id/PANDUAN-PEMBAYARAN-BNI.pdf">klik di sini.</a>
  <br>Setelah melakukan pembayaran, silahkan melengkapi identitas secara online pada website ppdb18.smam1ta.sch.id</i>
</div>
</div>
