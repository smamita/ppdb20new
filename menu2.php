                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" data-target="#democrou" href="identitas.html">Identitas</a>
                                </li>
                                <li><a data-toggle="collapse" data-target="#demolibra" href="logout.html">Logout</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                    ...
                    <li><a href="identitas.html"><i class="notika-icon notika-edit"></i> Identitas</a>
                    </li>
                    <li><a href="logout.html"><i class="notika-icon notika-bar-chart"></i> Logout</a>
                    </li>
                </ul>
            </div>
        </div>
