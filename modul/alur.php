                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="header-top-menu">
                        ...
                        <li class="nav-item dropdown">
                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">PPDB 2020/2021 SMA MUHAMMADIYAH 1 TAMAN</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="image-cropper-wp">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="image-crop" align="center">
                                    <img src="img/cropper/alur.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
